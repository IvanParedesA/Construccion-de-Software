...
function numero_hamburguesas() {
    return 12;
}

console.log(numero_hamburguesas());

//arrow function
let cantidad_hamburguesas = () => { return 12 };
console.log(cantidad_hamburguesas());
